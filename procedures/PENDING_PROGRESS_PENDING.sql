CREATE OR REPLACE PROCEDURE ILOS.pending_progress_pending (
    p_tgll IN VARCHAR2,
...
COUNT(*) AS TOTAL_APLIKASI,
  ...
  (a.NO_APLIKASI > ''20190615'' AND SUBSTR(a.CREATE_DATE,1,10) < '''|| p_tgll ||''') AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'') '|| v_where_area||') AS SUM_IDE,
  ...
  (a.JENIS_PRODUK LIKE ''%MITRAGUNA%'' OR a.JENIS_PRODUK LIKE ''%PENSIUN%'') AND
  (a.NO_APLIKASI > ''20190615'' AND SUBSTR(a.CREATE_DATE,1,10) < '''|| p_tgll ||''') AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'') '|| v_where_area||') AS SUM_DEDUPE,
  ...
  (a.JENIS_PRODUK LIKE ''%MITRAGUNA%'' OR a.JENIS_PRODUK LIKE ''%PENSIUN%'') AND
  (a.NO_APLIKASI > ''20190615'' AND SUBSTR(a.CREATE_DATE,1,10) < '''|| p_tgll ||''') AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'') '|| v_where_area||') AS SUM_IDEB,
  ...
  (a.JENIS_PRODUK LIKE ''%MITRAGUNA%'' OR a.JENIS_PRODUK LIKE ''%PENSIUN%'') AND
  (a.NO_APLIKASI > ''20190615'' AND SUBSTR(a.CREATE_DATE,1,10) < '''|| p_tgll ||''') AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'') '|| v_where_area||') AS SUM_UPLOAD,
  ...
  (a.JENIS_PRODUK LIKE ''%MITRAGUNA%'' OR a.JENIS_PRODUK LIKE ''%PENSIUN%'') AND
  (a.NO_APLIKASI > ''20190615'' AND SUBSTR(a.CREATE_DATE,1,10) < '''|| p_tgll ||''') AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'') '|| v_where_area||') AS SUM_DDE,
  ...
  (a.JENIS_PRODUK LIKE ''%MITRAGUNA%'' OR a.JENIS_PRODUK LIKE ''%PENSIUN%'') AND
  (a.NO_APLIKASI > ''20190615'' AND SUBSTR(a.CREATE_DATE,1,10) < '''|| p_tgll ||''') AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'') '|| v_where_area||') AS SUM_VERIN,
...
(SELECT
  ...
  (a.JENIS_PRODUK LIKE ''%MITRAGUNA%'' OR a.JENIS_PRODUK LIKE ''%PENSIUN%'') AND
  (a.NO_APLIKASI > ''20190615'' AND SUBSTR(a.CREATE_DATE,1,10) < '''|| p_tgll ||''') AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'') '|| v_where_area||') AS SUM_OTOR_VERIN,
...
(SELECT
  ...
  (a.JENIS_PRODUK LIKE ''%MITRAGUNA%'' OR a.JENIS_PRODUK LIKE ''%PENSIUN%'') AND
  (a.NO_APLIKASI > ''20190615'' AND SUBSTR(a.CREATE_DATE,1,10) < '''|| p_tgll ||''') AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'') '|| v_where_area||') AS SUM_VALID,
  ...
  (a.JENIS_PRODUK LIKE ''%MITRAGUNA%'' OR a.JENIS_PRODUK LIKE ''%PENSIUN%'') AND
  (a.NO_APLIKASI > ''20190615'' AND SUBSTR(a.CREATE_DATE,1,10) < '''|| p_tgll ||''') AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'') '|| v_where_area||') AS SUM_APPROVAL,
  ...
  (a.JENIS_PRODUK LIKE ''%MITRAGUNA%'' OR a.JENIS_PRODUK LIKE ''%PENSIUN%'') AND
  (a.NO_APLIKASI > ''20190615'' AND SUBSTR(a.CREATE_DATE,1,10) < '''|| p_tgll ||''') AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'') '|| v_where_area||') AS SUM_SP3,
  ...
  (a.JENIS_PRODUK LIKE ''%MITRAGUNA%'' OR a.JENIS_PRODUK LIKE ''%PENSIUN%'') AND
  (a.NO_APLIKASI > ''20190615'' AND SUBSTR(a.CREATE_DATE,1,10) < '''|| p_tgll ||''') AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'') '|| v_where_area||') AS SUM_AKAD,
...
(SELECT
  ...
  (a.JENIS_PRODUK LIKE ''%MITRAGUNA%'' OR a.JENIS_PRODUK LIKE ''%PENSIUN%'') AND
  (a.NO_APLIKASI > ''20190615'' AND SUBSTR(a.CREATE_DATE,1,10) < '''|| p_tgll ||''') AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'') '|| v_where_area||') AS SUM_OTOR_AKAD,
  ...
  (a.JENIS_PRODUK LIKE ''%MITRAGUNA%'' OR a.JENIS_PRODUK LIKE ''%PENSIUN%'') AND
  (a.NO_APLIKASI > ''20190615'' AND SUBSTR(a.CREATE_DATE,1,10) < '''|| p_tgll ||''') AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'') '|| v_where_area||') AS SUM_REVIEW,
...
(SELECT
  ...
  (a.JENIS_PRODUK LIKE ''%MITRAGUNA%'' OR a.JENIS_PRODUK LIKE ''%PENSIUN%'') AND
  (a.NO_APLIKASI > ''20190615'' AND SUBSTR(a.CREATE_DATE,1,10) < '''|| p_tgll ||''') AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'') '|| v_where_area||') AS SUM_OTOR_REVIEW,
  ...
  (a.JENIS_PRODUK LIKE ''%MITRAGUNA%'' OR a.JENIS_PRODUK LIKE ''%PENSIUN%'') AND
  (a.NO_APLIKASI > ''20190615'' AND SUBSTR(a.CREATE_DATE,1,10) < '''|| p_tgll ||''') AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'') '|| v_where_area||') AS SUM_LIVE,
  ...
  (a.JENIS_PRODUK LIKE ''%MITRAGUNA%'' OR a.JENIS_PRODUK LIKE ''%PENSIUN%'') AND
  (a.NO_APLIKASI > ''20190615'' AND SUBSTR(a.CREATE_DATE,1,10) < '''|| p_tgll ||''') AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'') '|| v_where_area||') AS SUM_CANCEL,
  ...
  WHERE  (a.FLOW_CODE LIKE ''%REJECT%'') AND
  (a.JENIS_PRODUK LIKE ''%MITRAGUNA%'' OR a.JENIS_PRODUK LIKE ''%PENSIUN%'') AND
  (a.NO_APLIKASI > ''20190615'' AND SUBSTR(a.CREATE_DATE,1,10) < '''|| p_tgll ||''') AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'') '|| v_where_area||') AS SUM_REJECT,
...
(SELECT
  ...
  WHERE 
  (a.JENIS_PRODUK LIKE ''%MITRAGUNA%'' OR a.JENIS_PRODUK LIKE ''%PENSIUN%'') AND
  (a.NO_APLIKASI > ''20190615'' AND SUBSTR(a.CREATE_DATE,1,10) < '''|| p_tgll ||''') AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'') '|| v_where_area||') AS SUM_TOTAL
...
WHERE 
(a.JENIS_PRODUK LIKE ''%MITRAGUNA%'' OR a.JENIS_PRODUK LIKE ''%PENSIUN%'') AND
(a.NO_APLIKASI > ''20190615'' AND SUBSTR(a.CREATE_DATE,1,10) < '''|| p_tgll ||''') 
