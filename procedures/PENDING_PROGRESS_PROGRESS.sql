CREATE OR REPLACE PROCEDURE ILOS.pending_progress_progress (
    p_tgll IN VARCHAR2,
    p_tgl_wise IN VARCHAR2,
...
COUNT(*) AS TOTAL_APLIKASI,
 ...
 ((SUBSTR(a.NO_APLIKASI,1,8) = '''|| p_tgl_wise ||''' OR SUBSTR(a.CREATE_DATE,1,10) = '''|| p_tgll ||''') 

AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'')) '|| v_where_area||') AS SUM_IDE,
...
AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'')) '|| v_where_area||') AS SUM_DEDUPE,
...
AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'')) '|| v_where_area||') AS SUM_IDEB,
...
AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'')) '|| v_where_area||') AS SUM_UPLOAD,
...
AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'')) '|| v_where_area||') AS SUM_DDE,
...
AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'')) '|| v_where_area||') AS SUM_VERIN,
...
AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'')) '|| v_where_area||') AS SUM_OTOR_VERIN,
...
AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'')) '|| v_where_area||') AS SUM_VALID,
...
AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'')) '|| v_where_area||') AS SUM_APPROVAL,
...
AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'')) '|| v_where_area||') AS SUM_SP3,
...
AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'')) '|| v_where_area||') AS SUM_AKAD,
...
AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'')) '|| v_where_area||') AS SUM_OTOR_AKAD,
...
AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'')) '|| v_where_area||') AS SUM_REVIEW,
...
AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'')) '|| v_where_area||') AS SUM_OTOR_REVIEW,
...
AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'')) '|| v_where_area||') AS SUM_LIVE,
...
AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'')) '|| v_where_area||') AS SUM_CANCEL,
...
AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'')) '|| v_where_area||') AS SUM_REJECT,
...
AND (a.FLOW_CODE NOT LIKE ''%_HOLD%'')) '|| v_where_area||') AS SUM_TOTAL
