...
export default function ButtonExport({ startDate, endDate, region, area, disabled = false }) {
  const handleButtonClick = async () => {
    // Fetch data directly without relying on state updates
    // Use empty string fallbacks for date values if they're undefined
    const params = { 
    ...
    // Ensure valid filenames by handling potential undefined values
