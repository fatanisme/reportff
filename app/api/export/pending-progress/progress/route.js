...
COUNT(*) AS TOTAL_APLIKASI,
 ...
 ((SUBSTR(a.NO_APLIKASI,1,8) = '${tgl_wise}' OR SUBSTR(a.CREATE_DATE,1,10) = '${tgll}') 

AND (a.FLOW_CODE NOT LIKE '%_HOLD%')) ${whereArea}) AS SUM_IDE,
...
AND (a.FLOW_CODE NOT LIKE '%_HOLD%')) ${whereArea}) AS SUM_DEDUPE,
...
AND (a.FLOW_CODE NOT LIKE '%_HOLD%')) ${whereArea}) AS SUM_IDEB,
...
AND (a.FLOW_CODE NOT LIKE '%_HOLD%')) ${whereArea}) AS SUM_UPLOAD,
...
AND (a.FLOW_CODE NOT LIKE '%_HOLD%')) ${whereArea}) AS SUM_DDE,
...
AND (a.FLOW_CODE NOT LIKE '%_HOLD%')) ${whereArea}) AS SUM_VERIN,
...
AND (a.FLOW_CODE NOT LIKE '%_HOLD%')) ${whereArea}) AS SUM_OTOR_VERIN,
...
AND (a.FLOW_CODE NOT LIKE '%_HOLD%')) ${whereArea}) AS SUM_VALID,
...
AND (a.FLOW_CODE NOT LIKE '%_HOLD%')) ${whereArea}) AS SUM_APPROVAL,
...
AND (a.FLOW_CODE NOT LIKE '%_HOLD%')) ${whereArea}) AS SUM_SP3,
...
AND (a.FLOW_CODE NOT LIKE '%_HOLD%')) ${whereArea}) AS SUM_AKAD,
...
AND (a.FLOW_CODE NOT LIKE '%_HOLD%')) ${whereArea}) AS SUM_OTOR_AKAD,
...
AND (a.FLOW_CODE NOT LIKE '%_HOLD%')) ${whereArea}) AS SUM_REVIEW,
...
AND (a.FLOW_CODE NOT LIKE '%_HOLD%')) ${whereArea}) AS SUM_OTOR_REVIEW,
...
AND (a.FLOW_CODE NOT LIKE '%_HOLD%')) ${whereArea}) AS SUM_LIVE,
...
AND (a.FLOW_CODE NOT LIKE '%_HOLD%')) ${whereArea}) AS SUM_CANCEL,
...
AND (a.FLOW_CODE NOT LIKE '%_HOLD%')) ${whereArea}) AS SUM_REJECT,
...
AND (a.FLOW_CODE NOT LIKE '%_HOLD%')) ${whereArea}) AS SUM_TOTAL
