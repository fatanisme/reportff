...
const PendingProgressGriya = () => {
  ...
  const fetchData = async () => {
    try {
      let url = "http://localhost:3000/api/pending-progress-griya?";
    ...
    <div className="p-6 bg-gray-100 min-h-screen">
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-6 items-end">
          ...
          <button className="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600">Download Data WISE</button>
        </div>
